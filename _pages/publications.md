...
author_profile: true
---
- Cai, Y., Zhang, L., He, Y., She, W., Cai, W., Wang, Y., **Gan, Y.**, Liu, Y., Cheng, C., Zhang, J., Shin, S., Guo, L. (2023). *Violet phosphorus with high-index and low-loss: A promising candidate for nanophotonics applications.* **Applied Physics Letters**, 123(2).
...
- Shi, R., Kong, D., Shen, N., **Gan, Y.**, Zhao, Y., Wang, Z., Wang, W., Wang, J., Amini, A., Wang, N., Cheng, C. (2020). *Low-temperature wafer-scale fabrication of vertical VO2 nanowire arrays.* **Applied Physics Letters**, 117(8).
